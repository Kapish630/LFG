		...
		<?php
			if(!isset($getUser)) {
				...
				echo "<div class='col-lg-10'>";
					...
					$sqlMembers = "SELECT * FROM Friends JOIN Player ON Player.PlayerID=Friends.PlayerID WHERE Player.PlayerID='" . $_SESSION["userbase"]->userId . "';";
							...
							echo "<div style='margin-bottom: 10px;' class='card'>";
								echo "<div class='card-body'>";
									echo "<p class='card-text'>";
										...
										echo "<a href='https://lfgproject.com/members/?user=" . $row["PlayerID"] . "'>" . $row["UserName"] . "</a>";
									echo "</p>";
								echo "</div>";
							echo "</div>";
						}
